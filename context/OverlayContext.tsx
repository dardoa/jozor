...
export const OverlayPrimitive: React.FC<OverlayPrimitiveProps> = ({
  ...
  return createPortal(
    <div
      className={className ?? backdropClassName ?? 'ds-overlay-backdrop fixed inset-0 z-[var(--z-index-modal)] flex items-end justify-center p-0 sm:items-center sm:p-4'}
      onClick={onClose}
    >
      <div
        ref={contentRef}
        className={contentClassName ?? 'relative z-[calc(var(--z-index-modal)+1)] w-full sm:w-auto'}
