...
-- Description: Historical duplicate snapshot of the bootstrap schema retained
--              for migration-history compatibility. The preferred executable
--              bootstrap entrypoint for fresh environments is:
--              20260218_bootstrap_core_schema.sql
--
-- Notes:
-- - This file remains intentionally non-destructive because it uses
--   IF NOT EXISTS / additive statements.
-- - New environments should still apply migrations in chronological order.
-- - The canonical schema contract is documented in:
--   20260318_document_core_schema_baseline.sql
