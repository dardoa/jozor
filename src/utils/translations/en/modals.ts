export const modals = {
  ...
  copyLink: 'Copy',
  copied: 'Copied',
  shareLink: 'Share Access',
  share: {
    defaultRoleNote: 'is the default for security.',
    previewNote: 'Open the same link yourself to preview.',
  },
  ...
  treeManager: {
    ...
    linkNote: 'This address does not grant access. Recipients must sign in with an authorized account or accept a tracked invitation.',
  ...
  statistics: {
    ...
    dataHealth: 'Structural Integrity',
    ...
    healthCenter: {
      ...
      warning: 'Warning',
      info: 'Info',
      allClearTitle: 'No structural conflicts found',
      ...
      currentIssuesHint: 'Issues disappear automatically after the underlying family data is corrected.',
      issueMessages: {
        broken_parent_reference: '{person} references a missing parent.',
        broken_child_reference: '{person} references a missing child.',
        broken_spouse_reference: '{person} references a missing spouse.',
        asymmetric_parent_child: '{person} has a parent-child link that is not reciprocal.',
        asymmetric_spouse: '{person} has a spouse link that is not reciprocal.',
        self_parent: '{person} is listed as their own parent.',
        self_child: '{person} is listed as their own child.',
        self_spouse: '{person} is listed as their own spouse.',
        duplicate_parent: '{person} has duplicate parent links.',
        duplicate_child: '{person} has duplicate child links.',
        duplicate_spouse: '{person} has duplicate spouse links.',
        parent_child_cycle: '{person} participates in a parent-child cycle.',
        death_before_birth: '{person} has a death date before the birth date.',
        child_before_parent_birth: '{person} is born before a listed parent.',
        mother_under_13: '{person} has a mother younger than 13 at birth.',
        possible_duplicate_person: '{person} may duplicate {related}.',
        missing_birth_date: '{person} is missing a birth date.',
        missing_death_date: '{person} is marked deceased but has no death date.',
        ...
        missing_birth_citation: '{person} has birth information without a citation.',
        missing_death_citation: '{person} has death information without a citation.',
  ...
  messages: {
    success: {
      ...
      role: 'Role updated',
      personLinked: 'Person linked successfully.',
