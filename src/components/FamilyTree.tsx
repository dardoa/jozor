...
import { useFamilyTreeLayoutController } from '../hooks/useFamilyTreeLayoutController';
import { useLayoutModeTransition } from '../hooks/useLayoutModeTransition';
import { buildMinimapGraphFromLayout } from '../domain/minimapGraph';
...
export const FamilyTree = React.memo(React.forwardRef<SVGSVGElement, FamilyTreeProps>((props, ref) => {
  ...
  const minimapGraph = React.useMemo(() => {
