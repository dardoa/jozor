...
import { TreeControlCenter } from '../TreeControlCenter';
...
vi.mock('../../modals/tabs/AccessControlTab', () => ({
  AccessControlTab: ({ treeId }: { treeId: string }) => <div>AccessControlTab:{treeId}</div>,
}));

vi.mock('../../modals/tabs/ActivityHistoryTab', () => ({
  ActivityHistoryTab: ({ treeId }: { treeId: string }) => <div>ActivityHistoryTab:{treeId}</div>,
}));

vi.mock('../../modals/tabs/VersionsTab', () => ({
  VersionsTab: ({ treeId }: { treeId: string }) => <div>VersionsTab:{treeId}</div>,
}));

vi.mock('../../modals/tabs/TreeSettingsTab', () => ({
  TreeSettingsTab: ({ treeId }: { treeId: string }) => <div>TreeSettingsTab:{treeId}</div>,
}));

vi.mock('../../DiagnosticsPanels', () => ({
  DiagnosticsPanels: () => <div>DiagnosticsPanels</div>,
}));

vi.mock('../../modals/tabs/TreeDangerZone', () => ({
  TreeDangerZone: ({ treeId }: { treeId: string }) => <div>TreeDangerZone:{treeId}</div>,
}));
