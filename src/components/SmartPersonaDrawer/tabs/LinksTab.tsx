...
const FamilyRelationshipsSection = lazy(() =>
  import('../../sidebar/FamilyRelationshipsSection').then((module) => ({ default: module.FamilyRelationshipsSection }))
);
const PartnersTab = lazy(() =>
  import('../../sidebar/PartnersTab').then((module) => ({ default: module.PartnersTab }))
);
