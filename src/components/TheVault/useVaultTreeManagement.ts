...
export const useVaultTreeManagement = ({
  ...
  const loadTrees = useCallback(async () => {
    ...
    // Optionally we can show toast here if we want, but tree loading happens silently often.
    // If it's a direct user action, a toast could be useful. But let's keep it silent unless failed.
