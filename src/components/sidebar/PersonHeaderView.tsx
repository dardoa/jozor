  ...
  ({ person, canEdit, onSelect, onOpenModal, familyActions, settings }) => {
    ...
    return (
      <div className='space-y-5 pb-4'>
        <div className='ds-sidebar-section animate-in fade-in flex min-w-0 flex-col gap-4 p-4 duration-200 sm:flex-row sm:items-start sm:gap-3 sm:p-5'>
          {/* Image */}
          ...
          {/* Info */}
          <div className='min-w-0 flex-1 space-y-2 pt-0 text-center sm:text-start'>
            <div>
        ...
        <div className='ds-sidebar-section p-4 space-y-2 animate-in fade-in slide-in-from-top-1 duration-200'>
          ...
          {person.isDeceased && (
            <button
              ...
              className={`${baseButtonClasses} bg-[var(--primary-600)] text-[var(--primary-text)] border-transparent`}
            >
          ...
          {canEdit && (
            <QuickAddSpeedDial
              ...
              buttonClassName={`${baseButtonClasses} bg-[var(--primary-50)] text-[var(--primary-600)] border-[rgba(var(--primary-600-rgb),0.14)]`}
            />
          )}
