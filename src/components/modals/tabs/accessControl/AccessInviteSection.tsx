...
export const AccessInviteSection: React.FC<{
  ...
  <section className={accessSectionClassName}>
    <h4 className="mb-2 flex items-center gap-2 text-[15px] font-bold tracking-tight text-slate-800">
      <UserPlus className="h-4 w-4 text-[#a67c37]" />
    ...
    <div className="flex flex-col gap-4">
      <div className="relative">
        ...
        <input
          ...
          className="min-h-11 w-full rounded-xl border border-black/[0.04] bg-white/55 ps-10 pe-3 py-3 text-sm text-slate-700 outline-none transition-all duration-200 ease-in-out placeholder:text-slate-400 focus:border-[#a67c37]/30 focus:bg-white"
        />
      </div>
      ...
      <button
        ...
        className="flex min-h-11 items-center justify-center gap-2 rounded-xl bg-[#a67c37] px-4 py-3 text-sm font-semibold text-white shadow-sm transition-all duration-200 ease-in-out hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-50"
      >
