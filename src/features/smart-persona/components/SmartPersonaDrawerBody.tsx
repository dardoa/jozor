...
const MediaTab = React.lazy(() =>
  import('./persona/MediaTab').then((module) => ({ default: module.MediaTab }))
);
        ...
        smartPersonaSize !== 'collapsed' && (
          <DrawerSectionErrorBoundary resetKey={tabBoundaryKey} fallback={drawerFallback}>
            <React.Suspense fallback={tabLoader}>
              {activeTab === 'about' && (
                <div id="persona-panel-about" role="tabpanel" aria-labelledby="persona-tab-about">
                  <AboutTab
                    person={person}
                    people={people}
                    isEditing={isEditing}
              ...
              {activeTab === 'links' && (
                <div id="persona-panel-links" role="tabpanel" aria-labelledby="persona-tab-links">
                  <LinksTab
                    person={person}
                    people={people}
                    onSelect={onSelect}
              ...
              {activeTab === 'media' && (
                <div id="persona-panel-media" role="tabpanel" aria-labelledby="persona-tab-media">
