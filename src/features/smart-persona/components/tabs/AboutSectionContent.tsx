...
const InfoTab = React.lazy(() =>
  import('../persona/InfoTab').then((module) => ({ default: module.InfoTab }))
);

const BioTab = React.lazy(() =>
  import('../persona/BioTab').then((module) => ({ default: module.BioTab }))
);

const ContactTab = React.lazy(() =>
  import('../persona/ContactTab').then((module) => ({ default: module.ContactTab }))
);
