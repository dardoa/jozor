        ...
        svg.selectAll('text')
            ...
            .on('end', function () {
                select(this)
                    ...
                    .on('mouseout', function (_event, d: unknown) {
                        const word = d as { text: string; value: number } | null | undefined;
                        if (word && typeof word.text === 'string') {
                            const originalIndex = data.findIndex(item => item.text === word.text);
