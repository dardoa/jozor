...
export function renderPosterSceneToSvg(
  ...
  const isFocusLayout = scene.layout.engineId === 'focus-family';
  const treeLabel = content.language === 'ar'
    ? (isFocusLayout ? '\u0627\u0644\u0639\u0627\u0626\u0644\u0629 \u062d\u0648\u0644 \u0627\u0644\u0634\u062e\u0635 \u0627\u0644\u0645\u062d\u0648\u0631\u064a' : isFullTreeScope ? '\u0627\u0644\u0634\u062c\u0631\u0629 \u0627\u0644\u0639\u0627\u0626\u0644\u064a\u0629 \u0627\u0644\u0643\u0627\u0645\u0644\u0629' : isSelectedBranchScope ? '\u0627\u0644\u0641\u0631\u0639 \u0627\u0644\u0639\u0627\u0626\u0644\u064a \u0627\u0644\u0645\u062d\u062f\u062f' : isDescendantScope ? '\u0634\u062c\u0631\u0629 \u0627\u0644\u0623\u062d\u0641\u0627\u062f' : '\u0634\u062c\u0631\u0629 \u0627\u0644\u0623\u0633\u0644\u0627\u0641')
    : (isFocusLayout ? 'Family around the focal person' : isFullTreeScope ? 'Full family tree' : isSelectedBranchScope ? 'Selected family branch' : isDescendantScope ? 'Descendant tree' : 'Ancestor tree');
  const scopeLabel = content.language === 'ar'
    ? (isFocusLayout ? '\u0627\u0644\u0646\u0637\u0627\u0642: \u062d\u0648\u0644 \u0627\u0644\u0634\u062e\u0635 \u0627\u0644\u0645\u062d\u0648\u0631\u064a' : isFullTreeScope ? '\u0627\u0644\u0646\u0637\u0627\u0642: \u0643\u0644 \u0627\u0644\u0639\u0644\u0627\u0642\u0627\u062a' : isSelectedBranchScope ? '\u0627\u0644\u0646\u0637\u0627\u0642: \u0627\u0644\u0641\u0631\u0639 \u0627\u0644\u0645\u062d\u062f\u062f' : isDescendantScope ? '\u0627\u0644\u0646\u0637\u0627\u0642: \u0627\u0644\u0623\u062d\u0641\u0627\u062f' : '\u0627\u0644\u0646\u0637\u0627\u0642: \u0627\u0644\u0623\u0633\u0644\u0627\u0641 \u0627\u0644\u0645\u0628\u0627\u0634\u0631\u0648\u0646')
    : (isFocusLayout ? 'Scope: family around focal person' : isFullTreeScope ? 'Scope: all relationships' : isSelectedBranchScope ? 'Scope: selected branch' : isDescendantScope ? 'Scope: descendants' : 'Scope: direct ancestors');
