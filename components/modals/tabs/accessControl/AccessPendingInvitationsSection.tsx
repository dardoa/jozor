...
export const AccessPendingInvitationsSection: React.FC<{
  ...
  <section className={accessSectionClassName}>
    ...
    {pendingInvitations.length === 0 ? (
      <div className="flex items-center justify-center rounded-2xl bg-white/45 py-4 text-center text-xs italic text-slate-400">
        ...
        {pendingInvitations.map((invitation) => (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-bold text-slate-800">{invitation.invited_email}</p>
