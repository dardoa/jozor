...
export const TreeHealthModal = memo(({ isOpen, onClose, onNavigateToPerson }: TreeHealthModalProps) => {
    ...
    return (
        <OverlayPrimitive
            isOpen={isOpen}
            onClose={onClose}
            id='tree-health-modal'
            backdropClassName='fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm'
        >
            <div 
                className='relative w-full max-w-4xl max-h-[90vh] overflow-y-auto bg-[var(--card-bg)] rounded-2xl shadow-2xl border border-[var(--border-main)] m-4'
