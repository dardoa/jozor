...
export const ConsistencyModal: React.FC<ConsistencyModalProps> = ({ 
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-2xl w-full flex flex-col max-h-[80vh] border border-gray-100 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
          <div className="flex items-center gap-2">
             ...
             <h3 className="text-lg font-bold text-gray-800 dark:text-white">{t.checkIssues}</h3>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 bg-gray-50 dark:bg-gray-900">
            {issues.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <h4 className="text-lg font-bold text-gray-800 dark:text-gray-100">{t.noIssuesFound}</h4>
                    <p className="text-sm text-gray-500 mt-1">Your tree data looks logically consistent.</p>
                </div>
            ) : (
                <div className="space-y-3">
                    <div className="flex items-center gap-2 mb-4 px-1">
                        <AlertTriangle className="w-4 h-4 text-orange-500" />
                        <span className="font-bold text-sm text-gray-700 dark:text-gray-300">{issues.length} {t.issuesFound}</span>
                    </div>
                    ...
                    {issues.map((issue) => {
                        ...
                        return (
                            <div key={issue.id} className="bg-white dark:bg-gray-800 p-4 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm flex gap-4">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <div className="flex items-center gap-2 flex-wrap">
                                        <button 
                                            ...
                                            className="inline-flex items-center gap-1 px-2.5 py-1 rounded-md bg-gray-100 dark:bg-gray-700 text-xs font-medium text-gray-700 dark:text-gray-300 hover:bg-blue-50 hover:text-blue-600 dark:hover:bg-gray-600 transition-colors"
                                        >
