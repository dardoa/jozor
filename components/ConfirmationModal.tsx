...
export const ConfirmationModal: React.FC<ConfirmationModalProps> = memo(
  ({ isOpen, onClose, onConfirm, title, message, confirmText, cancelText, type = 'danger', overlayId = 'confirmation-modal' }) => {
    ...
    return (
      <OverlayPrimitive
        ...
        isOpen={isOpen}
        onClose={onClose}
        backdropClassName='fixed inset-0 z-[100] flex items-center justify-center bg-stone-900/60 backdrop-blur-md p-4 animate-in fade-in duration-300'
