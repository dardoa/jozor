...
export const LinkPersonModal: React.FC<LinkPersonModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-2xl max-w-md w-full overflow-hidden flex flex-col max-h-[85vh] animate-in zoom-in-95 duration-200 border border-gray-100 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-900/50">
          <div>
             <h3 className="text-lg font-bold text-gray-800 dark:text-white">{t.add} {typeLabel}</h3>
             <p className="text-sm text-gray-500 dark:text-gray-400">{t.howToAdd}</p>
          </div>
        ...
        <div className="p-6 space-y-6 overflow-y-auto bg-white dark:bg-gray-800">
          ...
          <div className="relative flex items-center py-2">
            ...
            <span className="flex-shrink-0 mx-4 text-gray-400 text-xs font-medium uppercase">{t.or}</span>
            <div className="flex-grow border-t border-gray-200 dark:border-gray-700"></div>
          </div>
          ...
          <div className="space-y-3">
             ...
             <div className="relative">
                ...
                <input 
                    ...
                    className="w-full ps-10 pe-4 py-2 bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-lg text-sm focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 outline-none transition-all text-gray-900 dark:text-white"
                />
            </div>
            
            <div className="border border-gray-100 dark:border-gray-700 rounded-lg max-h-48 overflow-y-auto divide-y divide-gray-50 dark:divide-gray-700 bg-white dark:bg-gray-800 scrollbar-thin scrollbar-thumb-gray-200 dark:scrollbar-thumb-gray-600">
                {candidates.length === 0 ? (
                    <div className="p-4 text-center">
                        <User className="w-8 h-8 text-gray-200 dark:text-gray-600 mx-auto mb-2" />
                    ...
                    candidates.map(p => (
                        <button 
                            ...
                            className="w-full flex items-center gap-3 p-3 hover:bg-gray-50 dark:hover:bg-gray-700 text-start transition-colors group"
                        >
                            ...
                            <div>
                                <div className="text-sm font-semibold text-gray-700 dark:text-gray-200 group-hover:text-blue-700 dark:group-hover:text-blue-400">{p.firstName} {p.lastName}</div>
